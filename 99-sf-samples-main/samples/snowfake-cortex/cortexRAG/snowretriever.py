...
try:
    ...
    raise ImportError(
        "Snowpark Dependencies must be installed."
    )
...
class SnowflakeRM():
    ...
    def __init__(
        ...
        self.client = self._init_cortex(snowflake_session)
        self.k = k
    ...
    @classmethod
    def _init_cortex(cls, session: object) -> None:
        
        session.query_tag = {"origin": "sf_sit", "name": "xom", "version": {"major": 1, "minor": 0}}
        return session
